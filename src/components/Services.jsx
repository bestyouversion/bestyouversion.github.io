    ...
    <section id="services" style={{ background: 'var(--bg-primary)', padding: '120px 32px' }}>
      <div style={{ maxWidth: 960, margin: '0 auto' }}>
        ...
        <p style={{ fontFamily: 'var(--font-body)', fontSize: 15, lineHeight: 1.7, color: 'var(--text-muted)', margin: '0 0 48px', maxWidth: 560 }}>
          We offer a range of services, including anxiety and depression management, pain management, performance enhancement, and more. Each service is designed to promote healing, growth, and transformation.
        </p>

        {/* Service images row */}
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 40 }}>
          <img src={IMAGES.services1} alt="Therapy services" style={{ width: '100%', height: 200, objectFit: 'cover', borderRadius: 'var(--radius-lg)', border: '1px solid var(--accent-border)' }} />
          <img src={IMAGES.services2} alt="Healing environment" style={{ width: '100%', height: 200, objectFit: 'cover', borderRadius: 'var(--radius-lg)', border: '1px solid var(--accent-border)' }} />
        </div>
            ...
            return (
              <CardWrapper key={i} {...cardProps}>
                ...
                onMouseLeave={e => {
                  ...
                  {s.link && (
                    <div style={{ marginTop: 16, fontFamily: 'var(--font-body)', fontSize: 13, fontWeight: 500, color: 'var(--accent)' }}>Learn more →</div>
                  )}
                </div>
              </CardWrapper>
            )
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24, marginTop: 48, alignItems: 'center' }}>
          ...
          <div style={{ borderRadius: 'var(--radius-lg)', overflow: 'hidden', border: '1px solid var(--accent-border)' }}>
            <img src={IMAGES.consultation} alt="Consultation session" style={{ width: '100%', height: 280, objectFit: 'cover', display: 'block' }} />
          </div>
        </div>
      </div>
    </section>
